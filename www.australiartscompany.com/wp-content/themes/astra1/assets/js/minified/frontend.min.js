...
astraSmoothScroll = function(e, t) {
    ...
    function e(e) {
        ...
        "dropdown" === c && (document.getElementById("ast-mobile-popup").classList.remove("active", "show"), g("updateHeader")), "off-canvas" === c && e.forEach(function(e) {
    ...
    function t(e) {
        ...
        if ("off-canvas" === e) {
            ...
            for (var r = 0; r < a.length; r++) a[r].removeEventListener("click", astraNavMenuToggle, !1), a[r].removeEventListener("click", popupTriggerClick), a[r].addEventListener("click", popupTriggerClick, !1), a[r].trigger_type = "mobile";
            for (r = 0; r < n.length; r++) n[r].removeEventListener("click", astraNavMenuToggle, !1), n[r].removeEventListener("click", popupTriggerClick), n[r].addEventListener("click", popupTriggerClick, !1), n[r].trigger_type = "desktop";
            ...
            o.addEventListener("click", function(e) {
                ...
                27 === e.keyCode && (e.preventDefault(), document.getElementById("ast-mobile-popup").classList.remove("active", "show"), g(), t ? .focus())
            }), document.addEventListener("click", function(e) {
                e.target === document.querySelector(".ast-mobile-popup-drawer.active .ast-mobile-popup-overlay") && (document.getElementById("ast-mobile-popup").classList.remove("active", "show"), g(), t ? .focus())
            });
            ...
            if (s) {
                ...
                for (link = 0, len = c.length; link < len; link++) c[link].addEventListener("click", p, !0), c[link].headerType = "dropdown"
            }
            for (r = 0; r < a.length; r++) a[r].removeEventListener("click", popupTriggerClick, !1), a[r].removeEventListener("click", astraNavMenuToggle), a[r].addEventListener("click", astraNavMenuToggle, !1), a[r].trigger_type = "mobile";
            for (r = 0; r < n.length; r++) n[r].removeEventListener("click", popupTriggerClick, !1), n[r].removeEventListener("click", astraNavMenuToggle), n[r].addEventListener("click", astraNavMenuToggle, !1), n[r].trigger_type = "desktop";
            AstraToggleSetup()
        }
        v()
    }
    ...
    "" !== (m = null != d ? d.querySelector("#ast-mobile-header") : m) && null !== m && (c = m.dataset.type), document.addEventListener("astMobileHeaderTypeChange", e, !1), document.addEventListener("click", function(e) {
        ...
        r = document.querySelectorAll(".main-header-menu-toggle"), u.classList.remove("ast-main-header-nav-open"), document.addEventListener("astMobileHeaderTypeChange", e, !1), t(), v()
    });
                ...
                if (a && !a.classList.contains("astra-search-icon")) {
                    ...
                    if (n) {
                        if (n.className.includes("nav-menu") || (n.className += " nav-menu"), document.addEventListener("DOMContentLoaded", function() {
                                var e;
                                "off-canvas" === c && (e = document.getElementById("menu-toggle-close")) && (e.onclick = function() {
    ...
    for (var a, n, s, l, h = function() {
            ...
            if ("undefined" != typeof astraAddon && "function" == typeof astraToggleSetupPro) astraToggleSetupPro(c, u, i);
            else {
                var e, t, a, n = !1;
                if (0 < (e = "off-canvas" === c || "full-width" === c ? (t = document.querySelectorAll("#ast-mobile-popup, #ast-mobile-header"), (a = document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle")).length) : (t = document.querySelectorAll("#ast-mobile-header"), (n = !(0 < (e = (a = document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle")).length))) ? 1 : e)) || n)
                    for (var o = 0; o < e; o++)
        ...
        }, !1), k = navigator.userAgent, n = k.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [], /trident/i.test(n[1]) ? a = /\brv[ :]+(\d+)/g.exec(k) || [] : "Chrome" === n[1] && null != (a = k.match(/\bOPR|Edge\/(\d+)/)) || (n = n[2] ? [n[1], n[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (a = k.match(/version\/(\d+)/i)) && n.splice(1, 1, a[1]), "Safari" === n[0] && n[1] < 11 && document.body.classList.add("ast-safari-browser-less-than-11")), document.getElementsByClassName("astra-search-icon")), y = 0; y < f.length; y++) f[y].onclick = function(e) {
        var t;
    ...
    if (document.querySelectorAll(".search-field").forEach(e => {
        ...
        let o = e => {
            ...
            s = [];
        var k = document.querySelectorAll('a[href*="#"]:not([href="#"]):not([href="#0"]):not([href*="uagb-tab"]):not(.uagb-toc-link__trigger):not(.skip-link):not(.nav-links a):not([href*="tab-"])');
        if (k)
            for (let e of k) e.href.split("#")[0] !== location.href.split("#")[0] ? s.push({
                hash: e.hash,
                url: e.href.split("#")[0]
        ...
        window.addEventListener("DOMContentLoaded", e => {
            ...
            location.hash && setTimeout(() => t(new Event("click"), location.hash), 750)
        })
    }
    ...
    jQuery("body").hasClass("ast-main-header-nav-open") && (jQuery(".main-header-menu-toggle.toggled").removeClass("toggled"), jQuery(".main-header-bar-navigation.toggle-on").removeClass("toggle-on").css("display", ""), jQuery("body").removeClass("ast-main-header-nav-open"))
});